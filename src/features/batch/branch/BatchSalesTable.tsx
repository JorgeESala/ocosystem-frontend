              ...
              {sales.map((s) => {
                ...
                return (
                  <TableRow key={s.id}>
                    ...
                    <TableCell>
                      ${(s.saleTotal / s.kgTotal).toFixed(3)}
                    </TableCell>
                    ...
                    <TableCell>
                      <div className="flex flex-col items-center gap-1">
                        ...
                        {(() => {
                          ...
                          const count =
                            cuentaCounts.get(getCuentaKey(s, batch)) ?? 0;
          ...
          sales.map((s) => {
            ...
            return (
              ...
              >
                ...
                <div>
                  Promedio: {(s.kgTotal / s.quantitySold).toFixed(3)} kg
                </div>
              ...
              <TableBody className="divide-y text-center">
                {adjustments.map((adj: any) => (
                  <TableRow key={adj.id} className="bg-red-900/20">
                    ...
                    <TableCell className="text-red-200">
                      {adj.reason || "Sin motivo"}
                    </TableCell>
                    <TableCell className="font-semibold text-red-200">
                      {adj.quantity} aves
                    </TableCell>
                    <TableCell className="text-red-200">
                      {adj.weight ? `${adj.weight} kg` : "-"}
                    </TableCell>
                  </TableRow>
                ))}
              </TableBody>
