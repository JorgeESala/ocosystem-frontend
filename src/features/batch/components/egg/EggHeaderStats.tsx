...
export const EggHeaderStats: React.FC<{ batch: BatchResponseDTO }> = ({
  ...
  return (
    <div className="mt-2 flex flex-col gap-4">
      ...
      {/* FILA 2: Análisis Financiero y Comercial (4 columnas equilibradas) */}
