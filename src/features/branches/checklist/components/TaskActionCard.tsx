...
const ACCENT_PENDING: Record<string, string> = {
  ...
  amber:
    "bg-amber-900/40 text-amber-300 ring-amber-700/50 hover:bg-amber-800/50",
  purple:
    "bg-purple-900/40 text-purple-300 ring-purple-700/50 hover:bg-purple-800/50",
};
...
export default function TaskActionCard({
  ...
  if (isNotApplicable) {
    return (
      <div className="inline-flex items-center gap-1.5 rounded-full bg-slate-800/40 px-2.5 py-1 text-[11px] font-medium text-slate-600 ring-1 ring-slate-700/30">
